...
def create_indexes():
    nba_prediction.create_index([('game_key', 1)])
    nba_prediction.create_index([('game_date', 1)])
    nba_prediction.create_index([('away_team', 1)])
    nba_prediction.create_index([('home_team', 1)])
    nba_prediction.create_index([('prediction_key', 1)])
