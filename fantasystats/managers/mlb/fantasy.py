from fantasystats.models.mlb import fantasy
...
def insert_fantasy(
    ...
    try:
        t = fantasy.mlb_fantasy.objects.get(gameplayer_key=gameplayer_key)
...
def get_fantansy_by_player_name(player_name):
    ...
    return fantasy.mlb_fantasy.objects.filter(
        player_name=player_name
    ).order_by('-game_date')
